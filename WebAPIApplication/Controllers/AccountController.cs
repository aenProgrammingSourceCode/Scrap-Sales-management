    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    await UserManager.AddToRolesAsync(user.Id, "Incomplete");
            ...
            //    {
            //        case SignInStatus.Success:
            //            return RedirectToRegister(returnUrl, user.Id);
            //        case SignInStatus.LockedOut:
            //            return View("Lockout");
            //        case SignInStatus.RequiresVerification:
            //            return RedirectToAction("SendCode", new { ReturnUrl = returnUrl });
            ...
            //}
            //return View(model);
            //This my modified from Registration Default Code
        ...
        private ActionResult RedirectToRegister(string returnUrl,string userId)
        {
